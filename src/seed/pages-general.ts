...
const RECIPES: Record<string, Recipe> = {
  about: {
    ...
    points: [
      ...
      {
        title: "Campus",
        description: "The buildings, grounds and facilities pupils use.",
      },
    ],
    outro:
      "For anything not covered here, the school office is the best first point of contact.",
  },
  facilities: {
    eyebrow: "Campus",
    intro:
      "The spaces pupils learn, eat, play and gather in during the school day.",
    points: [
      {
        title: "Classrooms",
    ...
    outro:
      "Families are welcome to arrange a visit to see the campus in person.",
  },
  gallery: {
    eyebrow: "Gallery",
    intro:
      "Photographs from around the school and from events through the year.",
    points: [
      {
        title: "Around the campus",
        description: "Everyday spaces as pupils use them.",
      },
      {
  ...
  academics: {
    eyebrow: "Academics",
    intro:
      "What is taught, how it is taught, and how pupils are supported through the year.",
    points: [
      {
        title: "Curriculum",
      ...
      {
        title: "Support",
        description: "Help available to pupils who need it.",
      },
    ],
  },
  teachers: {
    eyebrow: "Our teachers",
    intro: "The staff who teach and look after pupils here.",
    points: [
      {
    ...
    outro:
      "To contact a member of staff, please write to the school office in the first instance.",
  },
  "annual-calendar": {
    eyebrow: "Calendar",
    intro:
    ...
    outro:
      "Dates can change. The office will confirm anything you are planning around.",
  },
  "school-rules": {
    eyebrow: "Rules and uniform",
    intro: "What is expected of pupils day to day, and what they should wear.",
    points: [
      ...
      },
      {
        title: "Conduct",
        description:
          "How pupils are expected to treat one another and the school.",
      },
    ],
  },
  admissions: {
    eyebrow: "Admissions",
    intro:
      "How to apply, what the school asks for, and who to speak to at each stage.",
    points: [
  ...
  "admissions-faq": {
    ...
    outro:
      "If your question is not answered here, please send it to the admissions office.",
  },
  updates: {
    eyebrow: "Updates",
    intro: "News, announcements and events from across the school.",
    points: [
      { title: "News", description: "Announcements for parents and pupils." },
  ...
  news: {
    eyebrow: "News",
    intro: "Announcements and notices for parents, pupils and staff.",
    points: [
  ...
  events: {
    eyebrow: "Events",
    intro:
      "School occasions through the year, with dates confirmed as they are set.",
    points: [
  ...
  achievements: {
    ...
    intro: "Recognition earned by pupils in academic work, sport and the arts.",
    points: [
      {
        title: "Academic",
    ...
    outro:
      "Pupils' names are published only where the school holds permission from a parent or guardian.",
  },
  "download-centre": {
    eyebrow: "Downloads",
    intro:
      "Forms, circulars and documents families need, gathered in one place.",
    points: [
  ...
  "student-life": {
    ...
    intro:
      "What pupils do beyond lessons — activities, responsibilities and the wider community.",
    points: [
      { title: "Activities", description: "Clubs, sport and the arts." },
      {
        title: "Creative work",
        description: "Writing, art and projects by pupils.",
      },
      {
        title: "Responsibility",
        description: "Roles pupils take on within the school.",
      },
    ],
  },
  "student-wall": {
    ...
    intro:
      "A place for pupils' own work — writing, artwork, photography and projects.",
    points: [
    ...
    outro:
      "Work is published with the pupil's name only where the school holds permission from a parent or guardian.",
  },
  "value-based-stories": {
    eyebrow: "Values",
    intro:
      "Short pieces on the values the school teaches, and how they show up in school life.",
    points: [
      {
        title: "Thought for the week",
        description: "A short reflection shared with pupils.",
      },
  ...
  alumni: {
    eyebrow: "Alumni",
    intro:
      "For former pupils — staying in touch, and news from the alumni community.",
    points: [
      {
        title: "Stay in touch",
      ...
      {
        title: "Alumni news",
        description: "What former pupils are doing now.",
      },
      {
        title: "Reunions",
        description: "Gatherings and events for former pupils.",
      },
    ],
    outro:
      "If you studied here and would like to reconnect, please get in touch.",
  },
  transport: {
    eyebrow: "Transport",
    intro:
  ...
  faq: {
    ...
    outro:
      "If your question is not answered here, please send it to the school office.",
  },
  contact: {
    eyebrow: "Contact",
  ...
  "parent-feedback": {
    eyebrow: "Feedback",
    intro:
      "The school welcomes comments, suggestions and concerns from parents and guardians.",
    points: [
      {
    ...
    outro:
      "Every message is read. Please include a way to reply if you would like a response.",
  },
  careers: {
    eyebrow: "Careers",
  ...
  newsletter: {
    eyebrow: "Newsletter",
    intro: "School news by email, for parents, guardians and former pupils.",
    points: [
      {
        title: "What is sent",
      ...
      },
      {
        title: "Your details",
        description:
          "Used only to send the newsletter, and you can stop at any time.",
      },
    ],
  },
  leadership: {
    eyebrow: "Leadership",
    intro:
      "The people responsible for running the institution and its schools.",
    points: [
      {
        title: "Management",
  ...
  "mandatory-documents": {
    eyebrow: "Disclosure",
    intro:
      "Documents the institution publishes for public reference, as required of schools.",
    points: [
      {
        title: "Recognition",
  ...
  community: {
    eyebrow: "Community",
    intro: "The wider school community — former pupils, families and staff.",
    points: [
      { title: "Alumni", description: "For former pupils." },
  ...
  scholarships: {
    ...
    intro:
      "Awards and assistance available to pupils, and how they are applied for.",
    points: [
...
const run = async () => {
  ...
  for (const page of blank) {
    ...
    const banner = wanted
      ? (usable.find((m) => m.filename === wanted)?.id ?? null)
      : null;
  ...
  if (noRecipe.length > 0) {
    payload.logger.warn(
      `No recipe, left blank: ${[...new Set(noRecipe)].sort().join(", ")}`,
    );
  }
  payload.logger.warn(
